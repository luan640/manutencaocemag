...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'funcionario.context_processors.area_ativa',
            ],
        },
    },
]
...
default_storage_backend = env(
    'DEFAULT_STORAGE_BACKEND',
    default=env('DEFAULT_FILE_STORAGE', default='storages.backends.s3boto3.S3Boto3Storage')
)
...
INTERNAL_JOB_TOKEN = env('INTERNAL_JOB_TOKEN', default='')
