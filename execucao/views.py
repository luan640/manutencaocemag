...
def execucao_data(request):
    ...
    for execucao in execucoes_page:
        data.append({
            ...
            'paplus': execucao.paplus if execucao.paplus is not None else '',
            'ph_agua': execucao.ph_agua if execucao.ph_agua is not None else '',
            'pvlye': execucao.pvlye if execucao.pvlye is not None else '',
